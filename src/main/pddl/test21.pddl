...
(:INIT 
    ...
    (isEmpty b11)(isEmpty b12)(isEmpty b13)(isEmpty b14)(isEmpty b15)
    (isEmpty b21)(isEmpty b24)(isEmpty b25)
    (isEmpty b31)(isEmpty b33)(isEmpty b35)
    (isEmpty b41)(isEmpty b42)(isEmpty b45)
    (isEmpty b51)(isEmpty b52)(isEmpty b53)
    (isEmpty b61)(isEmpty b62)(isEmpty b63)
    ;;On place les boites
    (isBox b23)(isBox b32)(isBox b43)
    ;;On définit le garde
    (isGuard b44)
    ;;On definit les TOPs
