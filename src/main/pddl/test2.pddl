...
(:INIT 
    ...
    (isEmpty b21)(isEmpty b23)(isEmpty b24)
    (isEmpty b31)(isEmpty b32)(isEmpty b35)
    (isEmpty b41)(isEmpty b42)(isEmpty b45)
    (isEmpty b53)(isEmpty b54)(isEmpty b55)
    (isEmpty b63)(isEmpty b64)(isEmpty b65)
    ;;On place les boites
    (isBox b33)(isBox b34)(isBox b43)
    ;;On définit le garde
    (isGuard b44)
    ;;On definit les TOPs
